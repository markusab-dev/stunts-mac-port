...
extern int16_t gState_total_finish_time;
extern int16_t gState_144;
extern int16_t gState_pEndFrame;
extern int16_t gState_oEndFrame;
extern int16_t gState_penalty;
extern int16_t gState_impactSpeed;
extern int16_t gState_topSpeed;
extern int16_t gState_jumpCount;
...
/*    push    bp
    ...
    or      ax, ax
    jz      int16_t loc_195FC
    cmp     ax, 1
    jz      int16_t loc_19612
    jmp     int16_t loc_19601*/
loc_195FC:
...
/*    mov     [bp+var_2], 0
    ...
    cmp     ax, 1
    jz      int16_t loc_1967F
    cmp     ax, 2
    jnz     int16_t loc_1962E
    jmp     loc_196DE*/
loc_1962E:
	if (arg_someFlag != 3)
		goto loc_19636;
...
loc_19636:
	...
	goto loc_1964E;
/*    cmp     ax, 4
    jz      int16_t loc_19642
    cmp     ax, 5
    jz      int16_t loc_19676
    jmp     int16_t loc_1964E*/
loc_19642:
...
loc_196B3:
	...
	goto loc_196D2;
/*    cmp     is_in_replay, 0
    jnz     int16_t loc_1964E
    cmp     byte_459D8, 0
    jz      int16_t loc_1964E
    cmp     [bp+arg_MplayerFlag], 0
    jnz     int16_t loc_196CE
    push    word_43964
    jmp     int16_t loc_196D2
    ; align 2
    db 144*/
loc_196CE:
    //push    word_4408C
...
loc_196DE:
	...
	goto loc_196FC;
/*    cmp     is_in_replay, 0
    jnz     int16_t loc_19704
    cmp     byte_459D8, 0
    jz      int16_t loc_19704
    cmp     [bp+arg_MplayerFlag], 0
    jnz     int16_t loc_196F8
    push    word_43964
    jmp     int16_t loc_196FC*/
loc_196F8:
	audio_function2_wrap(word_4408C);
    //push    word_4408C
loc_196FC:
