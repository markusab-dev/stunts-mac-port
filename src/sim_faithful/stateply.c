...
extern int32_t pState_lvec1_x;
extern int32_t pState_lvec1_y;
extern int32_t pState_lvec1_z;
extern int16_t pState_minusRotate_z_1;
extern int16_t pState_minusRotate_z_2;
extern int16_t pState_minusRotate_y_1;
extern int16_t pState_minusRotate_y_2;
extern int16_t pState_minusRotate_x_1;
...
extern int16_t nextPosAndNormalIP;
extern int16_t wallindex;
extern int16_t elRdWallRelated;
extern int16_t wallHeight;
extern int16_t wallStartX;
extern int16_t wallStartZ;
extern int16_t wallOrientation;
...
extern int16_t word_3BD72[4];
extern int16_t word_4408C;
extern int16_t word_43964;

extern void update_crash_state(int16_t, int16_t);
extern int16_t car_car_coll_detect_maybe(struct POINT2D*, struct VECTOR*, struct POINT2D*, struct VECTOR*);

extern int16_t bto_auxiliary1(int16_t, int16_t, struct VECTOR*);

void update_player_state(struct CARSTATE* arg_pState, struct SIMD* arg_pSimd, struct CARSTATE* arg_oState, struct SIMD* arg_oSimd, int16_t arg_MplayerFlag) {
	...
	char var_136;
	int16_t var_F4, var_F2, var_EE, var_138;
	uint16_t var_190;
	...
	if (framespersec == 0xA) {
		var_pSpeed2Scaled = ((int32_t)arg_pState->car_speed2 * 0x580) / 0x1E00;
	} else {
		var_pSpeed2Scaled = ((int32_t)arg_pState->car_speed2 * 0x580) / 0x3C00;
	}
...
/*
    ...
    jz      int16_t loc_14F76
    cmp     [bp+vec_FC.vy], 0
    jge     int16_t loc_14F76
    cmp     [bx+CARSTATE.car_speed2], 1E00h
    jbe     int16_t loc_14F6E
...
loc_15381:
	...
	goto loc_1540C;
/*    cmp     [bp+vec_1C.vz], 0
    jnz     int16_t loc_15398
    mov     ax, [bp+var_pSpeed2Scaled]
    mov     [bp+var_F4], ax
    mov     [bp+var_F2], 0
    jmp     int16_t loc_1540C
    ; align 2
    db 144*/
loc_15398:
	if (vec_C.z != 0)
...
nosmart
    ...
    mov     [bp+vec_FC.vy], 0
    cmp     [bp+var_EE], 100h
    jl      int16_t loc_1543A
    cmp     [bp+var_EE], 300h
    jle     int16_t loc_1544A*/
loc_1543A:
...
/*
    ...
    jbe     int16_t loc_15513
    cmp     [bp+var_138], 0
    jz      int16_t loc_154F8
    mov     ax, si
    neg     ax
    jmp     int16_t loc_154FA
    ; align 2
    db 144*/
loc_154F8:
    //mov     ax, si
...
loc_156AF:
    ...
    rcr     ax, 1
    dec     cl
    jnz     int16_t loc_156AF
    mov     [bp+vec_1C6.vy], ax
    cmp     state.game_inputmode, 2
    jz      int16_t loc_156D6
    push    [bp+vec_1C6.vz]
    push    ax
    push    [bp+vec_1C6.vx]
    push    planindex
...
loc_1599E:
	...
	goto loc_15A30;
/*    cmp     [bp+vec_C.vy], 0
    jle     int16_t loc_159AD
    cmp     [bp+vec_1C.vy], 0
    jge     int16_t loc_159AD
    jmp     loc_15A30*/
loc_159AD:
	vec_unk2.x = 0;
	vec_unk2.y = 0;
...
/*    push    ax
    ...
    mov     nextPosAndNormalIP, ax
    or      ax, ax
    jge     int16_t loc_15CDF
    cmp     [bp+var_136], 0
    jz      int16_t loc_15C75
    neg     ax
    add     ax, 6
    mov     nextPosAndNormalIP, ax*/
loc_15C75:
...
loc_15D7E:
    ...
    rcr     ax, 1
    dec     cl
    jnz     int16_t loc_15D7E
    mov     [bp+vec_1C6.vz], ax*/
	if (state.game_inputmode == 2)
		goto loc_15D94;
	goto loc_151BA;
/*    cmp     state.game_inputmode, 2
    jz      int16_t loc_15D94
    jmp     loc_151BA*/
loc_15D94:
	wallindex = -1;
...
/*    mov     al, [bp+var_wheelIndex]
    ...
    inc     [bp+var_wheelIndex]
    cmp     [bp+var_wheelIndex], 4
    jl      int16_t code_update_rotCoords
    cmp     pState_lvec1_y_dx, 0
    jge     int16_t loc_15FDE
    sub     ax, ax
...
/*    cmp     pState_lvec1_x_dx, 0
    jg      int16_t loc_1601B
    jl      int16_t loc_1600F
    cmp     pState_lvec1_x_ax, 0F00h
    jnb     int16_t loc_1601B*/
loc_1600F:
...
/*
    ...
    jg      int16_t loc_16057
    jl      int16_t loc_1604B
    cmp     pState_lvec1_z_ax, 0F00h
    jnb     int16_t loc_16057*/
loc_1604B:
...
/*    mov     ax, [bp+vec_1CC.vz]
    ...
    mov     [bp+var_F4], ax
    or      ax, ax
    jnz     int16_t loc_1611C
    cmp     [bp+var_F2], 0
    jl      int16_t loc_16146*/
loc_1611C:
...
/*
    ...
    or      ax, ax
    jge     int16_t loc_1613E
    neg     ax
    jmp     int16_t loc_16141
    ; align 2
    db 144*/
loc_1613E:
...
/*    mov     ax, [bp+vec_1D8.vx]
    ...
    mov     [bp+var_F4], ax
    or      ax, ax
    jnz     int16_t loc_161DE
    cmp     [bp+var_F2], 0
    jg      int16_t loc_16204*/
loc_161DE:
...
/*    push    [bp+var_F4]
    ...
    or      ax, ax
    jge     int16_t loc_161FC
    neg     ax
    jmp     int16_t loc_161FF*/
loc_161FC:
...
loc_16236:
	...
	goto loc_1624E;
/*    cmp     is_in_replay, 0
    jnz     int16_t loc_1625F
    cmp     [bp+arg_MplayerFlag], 0
    jz      int16_t loc_1624A
    push    word_4408C
    jmp     int16_t loc_1624E
    ; align 2
    db 144*/
loc_1624A:
...
/*
    ...
    jz      int16_t loc_16309
    or      si, si
    jge     int16_t loc_162EE
    or      ax, ax
    jg      int16_t loc_162F9*/
loc_162EE:
	if (si <= 0)
		goto loc_16309;
	if (var_138 >= 0)
		goto loc_16309;
/*    or      si, si
    jle     int16_t loc_16309
    cmp     [bp+var_138], 0
    jge     int16_t loc_16309*/
loc_162F9:
	update_crash_state(5, arg_MplayerFlag);
/*    mov     al, [bp+arg_MplayerFlag]
    cbw
...
/*    mov     bx, [bp+arg_pState]
    ...
    mov     [bp+var_11C], al
    cmp     [bp+arg_MplayerFlag], 0
    jnz     int16_t loc_1644C
    or      al, al
    jnz     int16_t loc_1644C
    cmp     [bx+CARSTATE.car_sumSurfAllWheels], 0
    jz      int16_t loc_1644C
...
/*    mov     bx, [bp+arg_oState]
    ...
    add     sp, 8
    or      al, al
    jz      int16_t loc_16578
    mov     bx, [bp+arg_pState]
    cmp     [bx+CARSTATE.field_C8], 0
    jz      int16_t loc_1653E
    jmp     loc_16892*/
loc_1653E:
...
/*    lea     ax, [bp+var_DC]
    ...
    mov     [bp+var_EC], al
    or      al, al
    jz      int16_t loc_16650
    sub     si, si
    jmp     int16_t loc_165F0
    ; align 2
    db 144*/
loc_165EA:
...
/*    mov     bx, si
    ...
    add     sp, 8
    or      al, al
    jz      int16_t loc_16710*/
	state.field_3FA[si] = 1;
	
	state_op_unk(si + 2, -arg_pState->car_rotate.x, ((int32_t)arg_pState->car_speed2 * 0x580) / 0x3C00);
	/*
